% ============================================================
% report.tex  —  Report analisi Bayesiana gerarchica profili SOC/N/P
%   Struttura definitiva con figure, tabelle ed equazioni del
...
\begin{figure}[htbp]
  ...
  \caption{Scatter plot intercetta--slope OLS per campo (logSOC).
    La correlazione positiva indica che i campi con SOC elevato in superficie
    mostrano profili con declino più marcato in profondità,
    confermando il pattern proporzionale del modello M-SP.}
  \label{fig:scatter}
\end{figure}
