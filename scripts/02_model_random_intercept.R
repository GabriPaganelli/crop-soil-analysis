...
# Fit salvato in: stan/fit_v2_no_gp_mu.rds
# =============================================================================
...
cat(sprintf("Parametri totali attesi: 3×%d + 33 = %d\n", J, 3 * J + 33))
rm(X_W, X_B); gc()
...
fit_path <- here("stan", "fit_v2_no_gp_mu.rds")
...
if (requireNamespace("loo", quietly = TRUE)) {
  ...
  modelli <- list(
    `M-SP`  = here("stan", "fit_v2_ri_slope_mu.rds"),
